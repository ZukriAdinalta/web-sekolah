        ...
        <div class="card-body">
         ...
         ?>
          <form action="/pengumuman/update/<?= $pengumuman['id']; ?>" method="Post" enctype="multipart/form-data">
            <?= csrf_field() ; ?>
            <input type="hidden" name="slug" value="<?= $pengumuman['slug'] ?>">
            <div class="form-group">
              <label for="isi">Judul Pengumuman</label>
              <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>"
                id="nama" name="nama" value="<?= (old('nama')) ? old('nama') : $pengumuman['nama']; ?>" autofocus
                autocomplete="off">
            ...
            <div class="form-group ck-editor__editable_inline">
              ...
              <textarea type="text" class="form-control  <?= ($validation->hasError('isi')) ? 'is-invalid' : ''; ?>"
                id="editor" name="isi" rows="10"><?= $pengumuman['isi'] ; ?></textarea>
              <div class="invalid-feedback">
