          ...
          <form action="/prestasi/update/<?= $prestasi['id']; ?>" method="Post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>"
                id="judul" name="judul" value="<?= (old('judul')) ? old('judul') : $prestasi['judul']; ?>" autofocus
                autocomplete="off">
            ...
            <div class="form-group">
              <label for="foto">Foto Prestasi Lama</label>
              <img src="/img/prestasi/<?= $prestasi['foto']; ?>" class="img-thumbnail mx-auto d-block" width="200px"
                height="300px" alt="<?= $prestasi['judul'];  ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group ck-editor__editable_inline">
              ...
              <textarea class="form-control  <?= ($validation->hasError('isi')) ? 'is-invalid' : ''; ?>" id="editor"
                name="isi" value="<?= old('isi') ; ?>"><?= $prestasi['isi'] ; ?></textarea>
              <div class="invalid-feedback">
